...
def vrm0_get_source_annotation(mode: Literal["UI", "OPERATOR"]) -> list[PropertyGroup]:
    """
...
def vrm0_add_items2annotation_ui_list() -> int:
    """
    ...
    """
    items = get_ui_vrm0_first_person_prop()

    # Current Sceneに存在するオブジェクトから対象オブジェクトを取得する｡
    source_annotation_list = vrm0_get_source_annotation("UI")
...
def vrm0_search_same_name_mesh_annotation(object_name: str) -> PropertyGroup:
    """
...
def vrm0_remove_mesh_annotation(source_object_name: str):
    """
